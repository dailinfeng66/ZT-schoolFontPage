...
export default {
  ...
  created() {
    this.roles = [];
    this.roles1 = sessionStorage.getItem("roles");
    switch (roles1) {
      case "000":
        this.roles.push("超级管理员");
        break;
      case "001":
        this.roles.push("总财务会计");
        break;
      case "002":
        this.roles.push("总审核员");
        break;
      case "003":
        this.roles.push("校区负责人");
        break;
      case "004":
        this.roles.push("校区财务会计");
        break;
      case "005":
        this.roles.push("校区审核员");
        break;
    }
  },
  data() {
