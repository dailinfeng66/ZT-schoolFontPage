<template>
  <el-collapse accordion>
    ...
    <el-collapse-item
      ...
      :name="value"
      :key="value"
      @click.native="findReply(value.comment._id)"
    >
      <div style="padding-left:80px;margin-bottom:20px">
        ...
        <el-button
          ...
          type="danger"
          size="mini"
          @click="deleteComment(value.comment._id)"
        >删除</el-button>
      </div>
      <el-collapse v-model="activeName">
        <el-collapse-item
          ...
          class="border"
          v-for="bvalue of blist"
          :title="bvalue.title"
          name="1"
          :key="bvalue"
        >
          <div style="padding-left:80px;">
            {{bvalue.reply.content}}
            <el-button
              style="margin-left:80px"
              type="danger"
              size="mini"
              @click="deleteReply(bvalue.reply._id)"
            >删除</el-button>
          </div>
        </el-collapse-item>
      </el-collapse>
